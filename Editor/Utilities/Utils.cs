...
namespace UnityEditor.Search
{
    ...
    static class Utils
    {
        ...
        private static MethodInfo s_ApplyUSSMethod;
        ...
        internal static GUIStyle FromUSS(string name)
        {
            ...
            {
                var type = typeof(UnityEditor.EditorStyles);
                s_FromUSSMethod = type.GetMethod("FromUSS", BindingFlags.NonPublic | BindingFlags.Static);
            }
            string ussInPlaceStyleOverride = null;
            return (GUIStyle)s_FromUSSMethod.Invoke(null, new object[] { name, ussInPlaceStyleOverride });
        }

        internal static GUIStyle FromUSS(GUIStyle @base, string name)
        {
            if (s_ApplyUSSMethod == null)
            {
                var type = typeof(UnityEditor.EditorStyles);
                s_ApplyUSSMethod = type.GetMethod("ApplyUSS", BindingFlags.NonPublic | BindingFlags.Static);
            }
            string ussInPlaceStyleOverride = null;
            return (GUIStyle)s_ApplyUSSMethod.Invoke(null, new object[] { @base, name, ussInPlaceStyleOverride });
        }
